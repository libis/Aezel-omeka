...
<div class="jumbotron">
   ...
   <section class='section-icons'>   <!-- Content -->
    <div class="container content-wrapper bs-docs-section ">
        ...
        <h3  class="ontdek"><span>Ontdek onze projecten</span></h3>
        <div class="row icons">    
            ...
            <div class="col-sm-7">
                <section class='nieuws'>
                    ...
                    <div class="row nieuws-item">
                        <div class="col-sm-3 icon-block"><img src="<?php echo img("bg6.png");?>"></div>  
                        <div class="col-sm-9 icon-block">
                            <h5>14-08-2016</h5>
                            <h4>Fusce dapibus</h4>
                    ...
                    <div class="row nieuws-item">
                        <div class="col-sm-3 icon-block"><img src="<?php echo img("foto.jpg");?>"></div>  
                        <div class="col-sm-9 icon-block">
                            <h5>14-08-2016</h5>
                    ...
                    <div class="row nieuws-item">
                        <div class="col-sm-3 icon-block"><img src="<?php echo img("bg5.jpg");?>"></div>  
                        <div class="col-sm-9 icon-block">
                            <h5>14-08-2016</h5>
